...
const OrderSuccess = () => {
  return (
    <div className="m-auto text-center items-center flex flex-col justify-center mt-20 h-96">
      ...
      <Link to="/orders" className="border-nonecursor-pointer outline-none bg-orange text-white text-sm p-2 m-2 transition-all duration-500 ease-in hover:bg-button-orange shadow-md rounded-md">View Orders</Link>
    </div>
  );
};
